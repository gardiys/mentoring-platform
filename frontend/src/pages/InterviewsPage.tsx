...
function InterviewQuestionDecks({ decks }: { decks: InterviewDeckListItem[] }) {
  return (
    <Stack gap="md" className="interview-question-hub">
      <div>
        <Text className="brand-eyebrow">Вопросы с собеседований</Text>
        <Title order={2}>Таблица и карточки для подготовки</Title>
        <Text c="dimmed" mt={4}>
          Отмечайте выученные вопросы в таблице или повторяйте их по системе
          интервальных карточек.
        </Text>
      </div>
