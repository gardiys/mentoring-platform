      ...
      <Group justify="space-between" align="flex-end">
        <div>
          ...
          <Text c="dimmed" size="sm" maw={760}>
            ...
            Ученики на испытательном сроке и завершившие обучение исключены из
            активности, но их офферы учитываются.
          </Text>
        </div>
        <Group>
          <Button
            ...
            <Stack gap={0}>
              <div style={{ padding: "var(--mantine-spacing-lg)" }}>
                ...
                <Text size="sm" c="dimmed" mt="xs">
                  ...
                  по дате запроса, офферы — по дате получения независимо от
                  текущего учебного статуса. Запись старого собеседования не
                  попадает в текущую неделю только из-за недавней загрузки.
                  Учитываются выбранные направление и доступ учеников; данные
                  относятся к их текущему ментору.
                </Text>
              </div>
              {query.data.mentors.length === 0 ? (
                <Text c="dimmed" p="lg" pt={0}>
                  Для выбранных фильтров нет учеников на учёбе/собеседованиях
                  или офферов за период.
                </Text>
              ) : (
